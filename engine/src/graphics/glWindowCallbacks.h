...
namespace Diamond {
	...
	private:
		...
		std::vector<std::function<void(int, int)>>            m_onResizeCallbacks;
		std::vector<std::function<void()>>                    m_onCloseCallbacks;
		std::vector<std::function<void(int, int, int, int)>>  m_onKeyCallbacks;
		std::vector<std::function<void(int, int, int)>>       m_onMouseButtonCallbacks;
		...
		std::vector<std::function<void(int)>>				  m_onFocusCallbacks;
	...
	public:
		...
		void addOnResizeCallback(std::function<void(int, int)> callback) { m_onResizeCallbacks.push_back(std::move(callback)); }
		void addOnCloseCallback(std::function<void()> callback) { m_onCloseCallbacks.push_back(std::move(callback)); }
		void addOnKeyCallback(std::function<void(int, int, int, int)> callback) { m_onKeyCallbacks.push_back(std::move(callback)); }
		void addOnMouseButtonCallback(std::function<void(int, int, int)> callback) { m_onMouseButtonCallbacks.push_back(std::move(callback)); }
		...
		void addOnFocusCallback(std::function<void(int)> callback) { m_onFocusCallbacks.push_back(std::move(callback)); }
	};
}